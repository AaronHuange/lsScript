...
import project.lushi.findimageentities.findcardimage.FindLaoJiuDeHuoBa

/**
 * 法术卡：老旧的火把
 */
class Card3LaoJiuDeHuoBa(imageFind: BaseImageFind = FindLaoJiuDeHuoBa(), cardLocationMode: CardLocationMode = CardLocationMode.IN牌库, atkNum: Int = 3, bloodNum: Int = 0, attribute: Attribute = Attribute.法术, pay: Int = 2, is嘲讽: Boolean = false, is磁力: Boolean = false, is吸血: Boolean = false, is冲锋: Boolean = false, is突袭: Boolean = false, is双生: Boolean = false, is发现: Boolean = false, is随从: Boolean = false)
