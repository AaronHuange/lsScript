...
import project.lushi.findimageentities.findcardimage.FindAnJinJiaoShiCong

/**
 * 法师卡：暗金教侍从
 */
class Card1AnJinJiaoShiCong(imageFind: BaseImageFind = FindAnJinJiaoShiCong(), cardLocationMode: CardLocationMode = CardLocationMode.IN牌库, atkNum: Int = 2, bloodNum: Int = 1, attribute: Attribute = Attribute.白板, pay: Int = 1, is嘲讽: Boolean = false, is磁力: Boolean = false, is吸血: Boolean = false, is冲锋: Boolean = false, is突袭: Boolean = false, is双生: Boolean = false, is发现: Boolean = false, is随从: Boolean = true)
